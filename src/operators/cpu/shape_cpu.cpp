 ...
 */
class ShapeCPUPlugin : public SimpleCPUPlugin<ShapeCPUPlugin> {
public:
    ...
    core::Status infer_output_shapes(
        ...
        // Output shape is [ndim]
        const int64_t ndim = static_cast<int64_t>(input_shapes[0].ndim());
        output_shapes.clear();
