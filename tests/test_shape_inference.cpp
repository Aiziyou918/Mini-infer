...
TEST(Conv2DShapeInferenceTest, ConvWithPadding) {
    ...
    std::vector<core::Shape> input_shapes = {core::Shape({1, 3, 28, 28}),
                                             core::Shape({64, 3, 5, 5})};
...
TEST(Conv2DShapeInferenceTest, ConvWithStride) {
    ...
    std::vector<core::Shape> input_shapes = {core::Shape({1, 64, 28, 28}),
...
TEST(LinearShapeInferenceTest, Basic2D) {
    ...
    std::vector<core::Shape> input_shapes = {core::Shape({32, 512}), core::Shape({10, 512}),
                                             core::Shape({10})};
...
TEST(LinearShapeInferenceTest, MultiDimensional) {
    ...
    std::vector<core::Shape> input_shapes = {core::Shape({4, 8, 128}), core::Shape({64, 128})};
...
TEST(ReLUShapeInferenceTest, PreservesShape) {
    ...
    std::vector<std::vector<int64_t>> test_shapes = {
        {1, 3, 224, 224}, {32, 512}, {1, 10}, {4, 8, 16, 32}};
...
TEST(FlattenShapeInferenceTest, DefaultAxis) {
    ...
    // Input: [1, 64, 7, 7]
    std::vector<core::Shape> input_shapes = {core::Shape({1, 64, 7, 7})};
...
TEST(ShapeInferenceErrorTest, LinearShapeMismatch) {
    ...
    std::vector<core::Shape> input_shapes = {
        core::Shape({32, 512}), core::Shape({10, 256})  // Wrong: should be [10, 512]
    };
